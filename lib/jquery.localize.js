...
(function ($) {
    ...
    $.localize = function (pkg, options) {
        var defaultCallback, deferred, fileExtension, intermediateLangData, jsonCall, lang, loadLanguage,
            ...
            localizeOptgroupElement, notifyDelegateLanguageLoaded, regexify, setAttrFromValueForKey,
            setTextFromValueForKey, valueForKey, wrappedSet;
        if (options == null) {
            options = {};
        }
        wrappedSet = this;
        ...
        jsonCall = function (file, pkg, lang, level) {
            ...
            ajaxOptions = {
                ...
                dataType: "json",
                async: true,
                timeout: options.timeout != null ? options.timeout : 50000,
                success: successFunc,
                error: errorFunc
            };
